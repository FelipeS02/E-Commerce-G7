const dispatch = (direction) => {
  return `
    <html>
    <head>
        <title>Tu orden fue despachada!</title>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <![endif]-->
                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr>
                                            <td align="left" valign="top"
                                                ...
                                                class="mobile-center">
                                                <h1 style="font-size: 34px; font-weight: 800; margin: 0; color: #ffffff;">
                                                    E-Commerce G7</h1>
                                            </td>
                                        </tr>
                                    </table>
                                                        ...
                                                        <td
                                                            ...
                                                            <a href="https://e-commerce-g7.vercel.app/" target="_blank"
                                                                style="color: #ffffff; text-decoration: none;"><img
                                                                    src="https://i.postimg.cc/Gp4gn16N/8848807b-909c-4432-a757-54bc264cd76e.png" width="27" height="23"
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <img src="https://i.postimg.cc/PqLP8rpN/Pngtree-fast-delivery-icon-delivery-icon-5279783.png"
                                                width="200" height="140" style="display: block; border: 0px;" /><br>
                                            <h2
                                                style="font-size: 30px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;">
                                                Tu orden fue despachada!
                                            </h2>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center"
                                            ...
                                            <p
                                                ...
                                                El tiempo estimado de entrega es de aproximadamente 15 dias habiles.
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                                ...
                                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top"
                                                            ...
                                                            <p style="font-weight: 800;">Direccion de entrega</p>
                                                            ${direction}
                                                        </td>
                                                    </tr>
                                                </table>
                    ...
                    <![endif]-->
                        ...
                        <tr>
                            <td align="center" style="padding: 5px; background-color: #044767;" bgcolor="#044767">
                                <!--[if (gte mso 9)|(IE)]>
                    <table align="center" border="0" cellspacing="0" cellpadding="0" width="600">
                    <tr>
                    <td align="center" valign="top" width="600">
                    <![endif]-->
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td align="center">
                                            <img src="https://i.postimg.cc/KctBNYPx/logosinnombre15x17-5cm.png" width="37"
                                                height="36" style="display: block; border: 0px;" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center"
                                            ...
                                            <p
                                                style="font-size: 14px; font-weight: 800; line-height: 18px; color: #f8f9fc;">
